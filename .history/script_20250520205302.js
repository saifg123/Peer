...
calendarEl.addEventListener("dragstart", e => {
  ...
  // Add balatro-anim class for animation
  banner.classList.add("balatro-anim");
  // Remove the animation class after animation ends (assume 400ms, or use animationend event if defined)
  banner.addEventListener("animationend", function handler() {
    banner.classList.remove("balatro-anim");
...
calendarEl.addEventListener("drop", e => {
  ...
  draggedNoteKey = null;
// (Removed duplicate dragstart handler; logic merged above)/ Add balatro-anim class for animation
  banner.classList.add("balatro-anim");
  // Remove the animation class after animation ends (assume 400ms, or use animationend event if defined)
  banner.addEventListener("animationend", function handler() {
    banner.classList.remove("balatro-anim");
