...
// Zoom in and out (with animation)
function zoom(direction) {
  ...
  console.log(`Zoomed ${direction} to:`, zoomLevels[currentIndex]);
  if (hoveredCell) {
    console.log("Hovered cell:", hoveredCell.textContent.trim());
  }
