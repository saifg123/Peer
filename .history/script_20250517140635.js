...
// ─── NEW: Click month-cell in Month view for full-day note ───
if (view === "month") {
  const mcell = e.target.closest(".month-cell");
  if (mcell && !mcell.classList.contains("empty")) {
  ...
  // … then your existing drill-in for month → week …
}
