...
document.addEventListener("mouseup", (e) => {
  if (draggingNote) {
    ...
    const cell = elementUnder?.closest(".calendar-cell");

    if (cell) {
      // Move original note to new cell
      cell.appendChild(originalNote);
      originalNote.classList.add("drop-bounce");

      // Clear transform after animation
      setTimeout(() => {
        originalNote.classList.remove("drop-bounce");
        originalNote.style.transform = "";
      }, 300);
    }
